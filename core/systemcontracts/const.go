...
var (
	...
	BasStakingPoolContract     = libcommon.HexToAddress("0x0000000000000000000000000000000000007001")
	BasGovernanceContract      = libcommon.HexToAddress("0x0000000000000000000000000000000000007002")
	BasChainConfigContract     = libcommon.HexToAddress("0x0000000000000000000000000000000000007003")
	BasRuntimeUpgradeContract  = libcommon.HexToAddress("0x0000000000000000000000000000000000007004")
	BasDeployerProxyContract   = libcommon.HexToAddress("0x0000000000000000000000000000000000007005")
)
